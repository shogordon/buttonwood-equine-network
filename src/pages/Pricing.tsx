    ...
    <div className="min-h-screen bg-gradient-to-br from-soft-ivory-50 to-french-blue-50">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/pricing" className="text-slate-gray-800 font-medium transition-colors">
                Pricing
              </Link>
      ...
      <div className="flex items-center justify-center p-6 pt-32">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-slate-gray-800 mb-4">Pricing Page - Coming Soon</h1>
          <p className="text-lg text-slate-gray-600">
            We're working on bringing you transparent pricing information.
          </p>
        </div>
      </div>
    </div>
