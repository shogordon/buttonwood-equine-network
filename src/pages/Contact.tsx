      ...
      <div className="flex items-center justify-center p-6 pt-32 relative">
        ...
        <div className="text-center relative z-10">
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-12 shadow-lg border border-white/10">
            <h1 className="text-4xl font-bold text-white mb-4 text-shadow">Contact Us - Coming Soon</h1>
            <p className="text-lg text-white/80">
              We're working on bringing you contact information and support options.
            </p>
          </div>
        </div>
      </div>
